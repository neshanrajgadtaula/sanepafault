...
class NaiveBayesModel(BaseModel):
    """Wrapper around sklearn GaussianNB."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._params = dict(var_smoothing=var_smoothing)
        self.model = GaussianNB(**self._params)
    ...
    def tune(
        ...
        def objective(trial):
            params = {
                "var_smoothing": trial.suggest_float("var_smoothing", 1e-12, 1e-4, log=True),
            }
            m = GaussianNB(**params)
