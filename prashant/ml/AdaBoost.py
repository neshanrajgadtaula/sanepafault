...
class AdaBoostModel(BaseModel):
    """Wrapper around sklearn AdaBoostClassifier."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = AdaBoostClassifier(**self._params)
    ...
    @classmethod
    def load(cls, path: str) -> "AdaBoostModel":
    ...
    def tune(
        ...
        def objective(trial):
            ...
            m = AdaBoostClassifier(**params, random_state=self._params["random_state"])
